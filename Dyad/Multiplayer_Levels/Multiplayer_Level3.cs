...
namespace Dyad
{
    class Multiplayer_Level3 : MultiplayerLevels
    {
        ...
        public override void LoadContent(List<SignedInGamer> gamers, PlayerIndex e)
        {
            ...
            allMoveableObjs.Add(new Terrain(new Vector2(1000, 600), RMSP, 0, .25f, true, true));
            allMoveableObjs.Add(new Terrain(new Vector2(1200, 600), RMSP, 0, .25f, true, true));

            Wall wall1 = new Wall(new Vector2(200, 593), @"Terrain\RustyMetalSmallPlatform", 1f, true);
            allMoveableObjs.Add(wall1);
            allMoveableObjs.Add(new Button(new Vector2(1200, 580), @"Objects\BlueButton", @"Objects\RedButton",
                .25f, true, wall1, 300, 593, true, 3));

            Wall wall2 = new Wall(new Vector2(628, 593), @"Terrain\RustyMetalSmallPlatform", 1f, true);
            allMoveableObjs.Add(wall2);
            allMoveableObjs.Add(new Button(new Vector2(1000, 580), @"Objects\BlueButton", @"Objects\RedButton",
                .25f, true, wall2, 300, 593, true, 3));

            allMoveableObjs.Add(new Terrain(new Vector2(900, 550), MW, 0, .5f, true, true));
            allMoveableObjs.Add(new Terrain(new Vector2(880, 250), MW, 0, .5f, true, true));
            allMoveableObjs.Add(new Terrain(new Vector2(1000, 160), MW, 0, .5f, true, true));
            allMoveableObjs.Add(new Terrain(new Vector2(1150, 50), MW, 0, .5f, true, true));


            allMoveableObjs.Add(new Terrain(new Vector2(200, 300), RMSP, 0, 1f, true, true));
            allMoveableObjs.Add(new Terrain(new Vector2(628, 300), RMSP, 0, 1f, true, true));            
